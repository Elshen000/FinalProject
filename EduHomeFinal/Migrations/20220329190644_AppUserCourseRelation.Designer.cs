...
namespace EduHomeFinal.Migrations
{
    ...
    [Migration("20220329190644_AppUserCourseRelation")]
    partial class AppUserCourseRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHomeFinal.Models.About", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "IT Brains Academy-nin ali məqsədi gənclərə və həvəsi olan hər kəsə IT və Proqramlaşdırma sahəsində karyera qurmaq və iş imkanları əldə etmək üçün dəstək olmaqdır. Operativ işləyən komandaya sahib olan  IT Brains Academy bugünə qədər 1000-lərlə tələbəyə həm əyani, həm də onlayn formada öz tövhəsini vermişdir. Tədris sonunda tələbələr müəyyən imtahanlar verərək sertifikatla təltif edilirlər. Eləcə də, biz sizi Microsoft, Cisco, CompTIA və.s. kimi nəhəng şirkətlərin imtahanlarına hazırlaşdıraraq sizin beynəlxalq sertifikatlı mütəxəssis olmağınıza zəmanət veririk.",
                            Icon = "footer-logo.png",
                            Image = "ItBrains-160737_5d6f.jpeg",
                            Information = " IT Brains Academy həmçinin böyük məqalə və videodərs bazasıdır. Belə ki, burada öyrənmək istədiyiniz sahələrə uyğun siz öz müəllim heyətimizin hazırladığı materiallar və videodərslərlə təmin edilirsiniz. Tədris və sistemimizin keyfiyyətini artırmaq məqsədilə IT Brains Academy daim sizin təklif və iradlarınıza məmnuniyyətlə cavab verməyə hazırdır. ",
                            Title = "IT BRAINS-Ə XOŞ GƏLMİŞSİNİZ!"
                        });
                });
            ...
            modelBuilder.Entity("EduHomeFinal.Models.Course", b =>
                {
                    b.HasOne("EduHomeFinal.Models.AppUser", "AppUser")
                        .WithMany("Courses")
